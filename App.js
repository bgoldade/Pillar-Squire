...
const [bagClubs, setBagClubs] = useState(CLUBS.map(c=>({…c,dist:c.defaultDist,inBag:true,make:””,model:””})));
...
<Text style={{fontSize:13,color:C.gold,fontFamily:FONT,fontWeight:“600”}}>Add a Club</Text>
</TouchableOpacity>
...
<Text style={[s.label,{color:C.gold,marginBottom:8}]}>SQUIRE”S FIRST READ</Text>
<Text style={{fontSize:13,color:C.textSecondary,lineHeight:22,fontFamily:FONT}}>
{noHcp?`Welcome to the bag, ${name.split(" ")[0]||"friend"}. I"ll start tracking your differentials from round one. After five rounds I"ll have your index.`
:parseFloat(hcpInput)<=5?`A ${hcpInput} — you know what you"re doing. I"ll focus on the details that separate good rounds from great ones.`
:parseFloat(hcpInput)<=12?`${hcpInput} handicap. There are clear shots to be gained here. I"ll track your SG data and tell you exactly where.`
:`${hcpInput}. Every shot tells a story. I"ll build your dispersion profile and give you a game plan before every round.`}
</Text>
</View>
<Text style={[s.label,{marginBottom:12}]}>HOW ACTIVE SHOULD I BE?</Text>
{[{v:“reactive”,title:“On Request”,desc:“Only when you ask. Quiet caddy.”},{v:“semi”,title:“Semi-Active”,desc:“Pre-shot briefs + when you ask. Recommended.”},{v:“proactive”,title:“Full Caddy”,desc:“I”ll speak up when I see something.”}].map(m=>(
